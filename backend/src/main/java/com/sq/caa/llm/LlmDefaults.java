 ...
 */
public record LlmDefaults(String baseUrl, String apiKey, String chatModel, String embedModel,
        int embedDimension, Duration timeout, int maxRetries, double temperature, int maxTokens) {
}
